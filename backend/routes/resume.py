...
def detect_platform_resume(text: str) -> bool:
    """Detect if a resume appears to be generated by our platform (well-structured)"""
    import re
    
    # Standard section headers that our platform uses
    standard_sections = [
    ...
    # Count how many standard sections are found (case-insensitive)
    text_upper = text.upper()
    sections_found = sum(1 for s in standard_sections if s in text_upper)
