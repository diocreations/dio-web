...
const AdminLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-violet-900 flex items-center justify-between px-4 z-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-violet-900 text-white z-40 transform transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-violet-800">
